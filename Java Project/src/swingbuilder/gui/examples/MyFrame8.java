 ...
 * @author HP
 */
public class MyFrame8 extends javax.swing.JFrame {

    /**
     * Creates new form MyFrame8
     */
    public MyFrame8() {
        initComponents();
    }
    ...
    private void btnShowSelectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowSelectionActionPerformed
        ...
        if(jrbMale.isSelected())
            ...
            gender="You Did Not Make A Selection!";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyFrame8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
